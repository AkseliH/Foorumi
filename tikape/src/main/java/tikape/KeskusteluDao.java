...
public class KeskusteluDao implements Dao<Keskustelu, Integer> {
    ...
    public Keskustelu findOne(Integer key) throws SQLException {
        ...
        PreparedStatement statement = connection.prepareStatement(
                ...
                + "GROUP BY Keskustelu.keskusteluid");
    ...
    public void insertWithViesti(Integer alueId, String otsikko, String sisalto, Timestamp aika, String nimimerkki) throws SQLException {
        ...
        if (database.isPostgre()) {
            ...
            try {
                ...
                statement = connection.prepareStatement("SELECT keskusteluid FROM Keskustelu ORDER BY keskusteluid DESC LIMIT 1;");
                ResultSet rs = statement.executeQuery();

                int keskusteluid = 0;
                if (rs.next()) {
                    keskusteluid = rs.getInt("keskusteluid");
                }
                rs.close();
